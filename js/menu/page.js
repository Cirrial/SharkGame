...
(a2a_config.vars = {
    ...
    process: function () {
        for (var e, a, t = a2a_config.vars.vars, n = 0, i = t.length; n < i; n++)
            void 0 !== (a = "string" == typeof t[n] ? ((e = t[n]), undefined) : ((e = t[n][0]), t[n][1])) &&
                "undefined" == typeof a2a_config[e] &&
                (a2a_config[e] = a);
    },
}),
...
var a2a = a2a || {
    ...
    canonical_url: (function () {
        ...
        var e,
            a = document.querySelector('meta[property="og:url"]');
        return a ? a.content : !!(e = document.querySelector('link[rel="canonical"]')) && e.href;
    })(),
    ieo: function () {
        for (
            var e = -1, a = document.createElement("b");
            (a.innerHTML = "\x3c!--[if gt IE " + ++e + "]>1<![endif]--\x3e"), +a.innerHTML;
    ...
    dom: {
        ...
        ready: function (e) {
            var a = function () {
                ...
                t = function (e) {
                    (document.addEventListener || "load" === e.type || "complete" === document.readyState) &&
                        (n(), a());
                },
                n = function () {
                    document.addEventListener
                        ...
                        : (document.detachEvent("onreadystatechange", t), window.detachEvent("onload", t));
                };
    ...
    init: function (e, a) {
        ...
        if ((n = l.target))
            if ("string" == typeof n) {
                if (((i = n.substr(0, 1)), (o = n.substr(1)), "." == i))
                    return a2a.multi_init(a2a.HTMLcollToArray(a2a.getByClass(o, document)), e, a), void (l.target = !1);
                0 <= (t = (s = a2a.gEl(o)).className).indexOf("a2a_kit") && t.indexOf("a2a_target") < 0 && (s = null);
            } else s = l.target;
        (e = l.menu_type ? "mail" : e) && ((a2a.type = e), l.vars.process()),
            (c.type = a2a.type),
            (c.node = s),
            ...
            (function (e, a) {
                ...
                var t,
                    n,
                    i = ((a2a["n" + a2a.n] = e).node = a2a.set_this_index(e.node)),
                ...
                i
                    ? (e.linkname_escape &&
                          (n =
                              a2a.getByClass("a2a_linkname_escape", i.parentNode)[0] ||
                              a2a.getByClass("a2a_linkname_escape", i.parentNode.parentNode)[0]) &&
                          (e.linkname = n.textContent || n.innerText),
                      ...
                      delete o,
                      i.a2a_kit ? a2a.kit(e, a) : a2a.button(e))
    ...
    init_all: function (a) {
        a2a.unindexed(function (e) {
            0 <= e.className.indexOf("a2a_follow")
                ? a2a.init("feed", { target: e })
                : a2a.init(a || "page", { target: e });
        }, !0) ||
    ...
    button: function (e) {
        ...
        (i.getAttribute("onclick") && -1 != (i.getAttribute("onclick") + "").indexOf("a2a_")) ||
            ...
            (a2a.add_event(i, "click", function (e) {
                ...
                if (
                    (a
                        ...
                        : 2 !== c && (a2a.show_menu(i), (a2a[o].last_focus = t), r.focus()),
            ...
            a2a.add_event(i, "mouseenter", function () {
                (a.style.willChange = "transform, opacity"),
                    (n("a2a_overlay").style.willChange = "backdrop-filter, opacity");
            })),
            "a" == i.tagName.toLowerCase() &&
                ...
                (i.href =
                    ...
                    "&title=" +
                    encodeURIComponent(e.linkname).replace(/'/g, "%27")),
            s &&
                "undefined" != typeof s.srcset &&
                /\/share_save_171_16.(?:gif|png)$/.test(s.src) &&
                (s.srcset = "https://static.addtoany.com/buttons/share_save_342_32.png 2x");
    },
    kit: function (o, e) {
        var a,
            t,
            ...
            d = function (e, a) {
                if (e && !a2a.in_array(e, s))
                    for (
                        var t = 0,
                            n = a ? a2a[p].services.most.concat(a2a[p].services.email) : a2a.services,
                            i = n.length;
                        t < i;
                        t++
                    )
            ...
            f = function (e, a, t) {
                var n = { node: a, service: e, title: S, url: E, media: B, mediaNode: h.a2a_mediaNode },
                    i = a2a.cbs("share", n);
                return (
                    void 0 !== i &&
                        (i.url && ((o.linkurl = i.url), (o.linkurl_implicit = !1)),
                        i.title && ((o.linkname = i.title), (o.linkname_implicit = !1)),
            ...
            P = {},
            O =
                o.linkurl_implicit && a2a.canonical_url
                    ? encodeURIComponent(a2a.canonical_url).replace(/'/g, "%27")
                    : C,
            H = v["a2a-scroll-show"],
        ...
        D &&
            ...
            T &&
                "unset" != T &&
                a2a.svg.works() &&
                (L && "unset" != L && (j.backgroundColor = L), N && "unset" != N.trim() && (N = N.trim())),
            ...
            32 != D &&
                ((j.backgroundSize = j.height = j.lineHeight = j.width = I),
                (P.borderRadius = j.borderRadius = (0.14 * D).toFixed() + "px"),
            ...
            (a2a.kit.facebook_like = function () {
                ...
                var e,
                    ...
                    n,
                    i = a2a.i18n();
                for (var o in (2 == (i = i ? i.replace(/-/, "_") : "en_US").length && (i += "_" + i.toUpperCase()), pe))
                    ue += " data-" + o + '="' + pe[o] + '"';
                window.fbAsyncInit ||
            ...
            (a2a.kit.twitter_tweet = function () {
                ...
                try {
                    twttr.ready(function (e) {
                        a2a.twitter_bind ||
                            (e.events.bind("click", function (l) {
                                if (l && "tweet" == l.region) {
                                    var e = (function () {
            ...
            (a2a.kit.pinterest_pin = function () {
                ...
                "beside" == pe["pin-config"] && "buttonPin" == pe["pin-do"] && (V.style.width = "76px"),
                    (n.href =
                        ...
                        pe.url +
                        (pe.media ? "&media=" + pe.media : "") +
                        (pe.description
                            ? "&description=" + encodeURIComponent(pe.description).replace(/'/g, "%27")
                            : "")),
            ...
            (a2a.kit.linkedin_share = function () {
                for (var e in ((pe.onsuccess = "a2a.kit.linkedin_share_event"), (pe.url = E), (pe = u(V, pe))))
                    ue += " data-" + e + '="' + pe[e] + '"';
                var a, t, n;
        ...
        for (var $ = 0; $ < b; $++) {
            ...
            if (K)
                (e.target = V),
                    ...
                    (ie = Q = "a2a"),
                    (de = X && 1),
                    0 <= y.indexOf("a2a_floating_style") && (V.a2a_floating = 1);
            else if ("feed" == Q || "print" == Q) te = ne = "";
            else if ("copy_link" == Q)
                a2a.add_event(V, "mouseenter", function () {
                    (a2a.gEl("a2a_modal").style.willChange = "transform, opacity"),
                        (a2a.gEl("a2a_overlay").style.willChange = "backdrop-filter, opacity");
                });
            ...
            if (Q && !g(Q, ["google_plus", "stumbleupon"]) && !ce) {
                if (
                    (K ||
                        ...
                        !k || (!r[Q] && d(Q, !0))
                            ? "feed" == Q
                                ...
                                : ((V.href = "/#" + Q),
                                  "js" === re
                                      ? a2a.add_event(V, "click", m)
                                      : (a2a.add_event(V, "mousedown", m), a2a.add_event(V, "keydown", m)),
                                  (V.rel = "nofollow" + te))
                            : (V.href =
                                  ((t = Q),
                                  (l = n = void 0),
                            ...
                            a2a.add_event(
                                ...
                                (function (r, s, c, d, u) {
                                    return function (e) {
                                        ...
                                        (t = !(!(a = f(s, u, e)) || !a.stop)),
                                            (n = u.a2a.js_skip),
                                            "feed" == p || u.a2a.url || u.a2a.js_src || a2a.postClick(h),
                                            !u.a2a.popup ||
                                                a2a.defaultPrevented(e) ||
                                                i ||
                    ...
                    for (var me, fe, _e, ge = 0, he = Z.length; ge < he; ge++)
                        if (
                            ((_e =
                                (fe = "string" == typeof (me = Z[ge].className)) &&
                                ("a2a_label" === me || 0 <= me.indexOf("a2a_ignore"))),
                            1 == Z[ge].nodeType && (_e || (G = !0), fe && 0 <= me.indexOf("a2a_count")))
                        ) {
                            q = !0;
                            break;
                        }
                    ...
                    V.appendChild(U),
                        ...
                        (U.innerHTML = ae || ("feed" == p ? a2a.c.localize.Subscribe : a2a.c.localize.Share)),
                        ae ||
                            ((U.className += " a2a_localize"),
                            U.setAttribute("data-a2a-localize", "inner," + ("feed" == p ? "Subscribe" : "Share"))),
                        V.appendChild(U);
                }
                if ((R && D && D < 20 && (de = !1), de && !q)) {
                    ...
                    V.appendChild(U),
                        K
                            ? ((U.a2a.is_a2a_dd_counter = 1),
                              (h.a2a_dd_counter = U),
                              a2a.counters.get("facebook", U, O))
                            : a2a.counters.get(Q, U, O);
                }
    ...
    counters: {
        get: function (i, o, e, l) {
            a2a_config.counts;
            var r,
                a,
                t = decodeURIComponent(e),
                n = a2a.counters.bonus(i, t, e, o.a2a.kit),
                s = "",
                c = a2a.counters[i],
                d = c.api,
                          ...
                          (c["cb" + c.n] = function (e) {
                              ...
                              if (void 0 !== t) {
                                  ...
                                  for (var n = 0; n < r.queued.length; n++)
                                      (queued_count_element = r.queued[n]),
                                          (r.num = t),
                                          queued_count_element.a2a.is_a2a_dd_counter
                                              ? a2a.counters.sum(queued_count_element, t, i + s)
                                              : a2a.counters.set(queued_count_element, t, i + s);
                              }
                          }),
                          1 == r.queued.length &&
                              ((a = d[0] + e + (d[1] || "&callback") + "=a2a.counters." + i + ".cb" + c.n),
        ...
        set: function (e, a, t) {
            ...
            (a = "undefined" != typeof e.a2a.last_count ? e.a2a.last_count + a : a),
                ...
                "a2a" != t && ((e.a2a.last_count = n), a2a.counters.sum(e, n, t));
        },
        sum: function (e, a, t) {
            var n = e.a2a.kit,
            ...
            "a2a" != t &&
                -1 === o.indexOf(t) &&
                ((i = n.a2a_counts_sum = i + a), (o = n.a2a_counts_summed = o || []).push(t)),
            ...
            return (
                r &&
                    (r.recover_protocol &&
                        ...
                        ((i = t.replace(/^https%/, "http%")), (a = decodeURIComponent(i))),
                    r.recover_domain &&
                        ((i = encodeURIComponent(
                            a.replace(/^(https?\:\/\/)(?:[^\/?#]+)([\/?#]|$)/i, "$1" + r.recover_domain + "$2")
                        )),
        ...
        facebook: {
            ...
            cb: function (e, a) {
                return e && e.og_object && e.og_object.engagement && !isNaN(e.og_object.engagement.count)
    ...
    overlays: function () {
        ...
        function o(e, a, t, n) {
            ...
            if (a2a.matches(m, n) && "false" !== m.getAttribute("data-a2a-overlay")) {
                ...
                (o = a2a.getPos(m, "scroll")),
                    ...
                    (a.a2a_mediaNode = m).alt
                        ? a.setAttribute("data-a2a-title", m.alt)
                        : a.setAttribute("data-a2a-title", b),
                    !h || ("#" !== h.substr(0, 1) && "http" !== h.substr(0, 4))
                        ? a.setAttribute("data-a2a-url", w)
                        : ((p = "#" === h.substr(0, 1) ? w.split("#")[0] + m.longDesc : h),
        ...
        for (var l = 0, r = e.length; l < r; l++) {
            var s,
                ...
                x = Math.round;
            if (
                ((m = m && 2 < m.length ? m.split(" ") : ["top", "left"]),
                (f = !f || ("horizontal" !== f && "default" !== f) ? "vertical" : "default"),
                (g = g || "img"),
                p)
            )
                document.body.insertAdjacentHTML("beforeend", p), (s = document.body.lastChild);
            else {
                for (var h = 0, v = d.length; h < v; h++) {
                    u += '<a class="a2a_button_' + d[h] + '"></a>';
                }
                ((s = document.createElement("div")).className =
                    "a2a_kit a2a_kit_size_" + _ + " a2a_overlay_style a2a_" + f + "_style"),
                    (s.innerHTML = u),
    ...
    init_show: function () {
        var e = a2a_config,
            ...
            n = a2a.init_show,
            i = a2a.n;
        e.bookmarklet && ((a.no_hide = 1), (a2a.sole_index = i), t()),
            e.show_menu && ((a.no_hide = 1), (a2a.sole_index = i), t(!1, e.show_menu), (e.show_menu = !1)),
            (n.a2a_done = 1);
    },
    unindexed: function (o, e) {
        ...
        function l(e) {
            for (var a, t, n = 0, i = e.length; n < i; n++)
                if (
                    (("undefined" == typeof (a = e[n]).a2a_index || "" === a.a2a_index) &&
        ...
        return (
            document.getElementsByClassName && /\{\s*\[native code\]\s*\}/.test("" + document.getElementsByClassName)
                ? (a2a.getByClass = function (e, a, t) {
                      for (
                          var n,
                              i = (a = a || a2a.gEl("a2a" + a2a.type + "_dropdown")).getElementsByClassName(e),
                ...
                ? (a2a.getByClass = function (e, a, t) {
                      ...
                      for (
                          var n,
                              ...
                              s = document.documentElement.namespaceURI === r ? r : null,
                              c = [],
                              d = 0,
                              u = o.length;
                          d < u;
                ...
                : (a2a.getByClass = function (e, a, t) {
                      ...
                      for (
                          var n,
                              ...
                              o = e.split(" "),
                              l = [],
                              r = "*" === t && a.all ? a.all : a.getElementsByTagName(t),
                              s = [],
                              c = 0,
                              d = o.length;
                          c < d;
    ...
    defaultPrevented: function (e) {
        return !!(
            e.defaultPrevented ||
            !1 === e.returnValue ||
            ("undefined" == typeof e.defaultPrevented && e.getPreventDefault && e.getPreventDefault())
        );
    },
    onLoad: function (e) {
        var a = window.onload;
        ...
        for (var n in e)
            if (e.hasOwnProperty(n)) {
                var i = a ? a + "[" + n + "]" : n,
                    o = e[n];
                t.push(
                    "object" == typeof o ? a2a.serialize(o, i) : encodeURIComponent(i) + "=" + encodeURIComponent(o)
                );
            }
        return t.join("&");
    },
        ...
        var c =
            ...
            e = function () {
                ...
                return (
                    ...
                    (r = arguments),
                    a <= 0 || n < a
                        ? (o && (clearTimeout(o), (o = null)), (previous = e), (s = t.apply(l, r)), o || (l = r = null))
                        : o || !1 === i.trailing || (o = setTimeout(d, a)),
                    s
                );
            };
        return (
    ...
    miniLeaveDelay: function () {
        var e = a2a.type,
            a = "a2a" + e,
            t = a2a.gEl;
        a2a.isDisplayed(t(a + "_dropdown")) &&
            "none" === a2a.getStyle(t(a + "_full"), "display") &&
            (a2a[e].out_delay = setTimeout(function () {
    ...
    toggle_dropdown: function (e, a) {
        if ("none" != e || !a2a[a].no_hide) {
            ...
            (t.style.display = e),
                a2a.miniEnterStay(),
                "none" == e &&
                    (a2a.show_menu["doc_click_listener_" + a].destroy(),
    ...
    getPos: function (e, a) {
        ...
        return "undefined" == typeof e.getBoundingClientRect
            ? a2a.getPosOld(e)
            : { left: n((t = e.getBoundingClientRect()).left + i), top: n(t.top + o) };
    },
    ...
    getDocDims: function (e) {
        ...
        return (
            "number" == typeof window.innerWidth
                ? ((a = window.innerWidth), (t = window.innerHeight))
                : document.documentElement &&
                  (document.documentElement.clientWidth || document.documentElement.clientHeight)
                ? ((a = document.documentElement.clientWidth), (t = document.documentElement.clientHeight))
                : document.body &&
                  (document.body.clientWidth || document.body.clientHeight) &&
                  ((a = document.body.clientWidth), (t = document.body.clientHeight)),
            "w" == e ? a : t
        );
    },
    getScrollDocDims: function (e) {
        ...
        return (
            "number" == typeof window.pageYOffset
                ...
                ? ((a = document.body.scrollLeft), (t = document.body.scrollTop))
                : document.documentElement &&
                  (document.documentElement.scrollLeft || document.documentElement.scrollTop) &&
                  ((a = document.documentElement.scrollLeft), (t = document.documentElement.scrollTop)),
            "w" == e ? a : t
        );
    },
    ...
    selection: function (e) {
        ...
        if (a2a["n" + a2a.n].linkurl === location.href && -1 === ["facebook", "twitter", "linkedin"].indexOf(e))
            for (var o, l, r = 0; r < i; r++)
                if (
                    ((o = (o = n[r].getAttribute("name")) ? o.toLowerCase() : ""),
    ...
    cbs: function (e, a) {
        ...
        n &&
            (n[e]
                ...
                : n[0] == e
                ? ((i[e] = n[1]), t.push(i))
                : "function" == typeof n && ((i[e] = n), t.push(i)),
            (a2a.c.tracking_callback = null));
        for (var o, l = 0, r = t.length; l < r; l++)
            if (
                "function" == typeof (o = t[l][e]) &&
                ((returned = o(a)), "ready" == e && (o = null), "undefined" != typeof returned)
            )
                return returned;
    },
    linker: function (e) {
        var a,
            ...
            g =
                !l.track_links || ("page" != r && "mail" != r)
                    ? ""
                    : "&linktrack=" + l.track_links + "&linktrackkey=" + encodeURIComponent(l.track_links_key),
        ...
        if (w && f) (e.a2a.js_skip = 1), (e.target = "_blank");
            ...
            (e.target = ""),
                "javascript:" == y.substr(0, 11)
                    ? ((t = y.replace("${link}", c.replace(/'/g, "\\'"))), (e.a2a.literalJS = t.substr(11)))
                    : (e.a2a.externalJS = y),
                (a = "#" + s);
        else if (k && (s != A || (s == A && (a2a.is_mobile || C))) && !g) {
            if (((e.target = ""), "object" == typeof x)) for (var B in x) k = a2a.urlParam(k, B, S(x[B]));
            ...
            (e.href =
                ...
                "http" +
                    ...
                    (function T() {
                        ...
                        return (
                            x
                                ? (e = "&" + a2a.serialize({ template: x }))
                                : b[A] && v && v == A && (e = "&" + a2a.serialize({ template: b[A] })),
                            e
                        );
                    })() +
                    ("feed" == r ? "&type=feed" : "") +
    ...
    show_modal: function () {
        a2a.type;
        for (
            var e = a2a.gEl, a = (e("a2a_overlay"), e("a2a_modal")), t = a2a.getByClass("a2a_modal_body", a), n = 0;
            n < t.length;
            n++
        )
    ...
    show_menu: function (e, a) {
        ...
        a2a.fill_menus(_),
            (a2a.gEl(g + "_title").value = f.linkname),
            a2a.toggle_dropdown("block", _),
            (i = [h.clientWidth, h.clientHeight]),
            (o = a2a.getDocDims("w")),
            (l = a2a.getDocDims("h")),
            e
                ? ((n = (t = e.a2a_floating) ? "viewport" : "scroll"),
                  (h.style.position = t ? "fixed" : ""),
                  (r = t ? 0 : a2a.getScrollDocDims("w")),
                  (s = t ? 0 : a2a.getScrollDocDims("h")),
                  (p = (c = e.getElementsByTagName("img")[0])
                      ? ((d = a2a.getPos(c, n)), (u = c.clientWidth), c.clientHeight)
                      : ((d = a2a.getPos(e, n)), (u = e.offsetWidth), e.offsetHeight)),
                  d.left - r + i[0] + u > o && (d.left = d.left - i[0] + u - 8),
                  ("up" == f.orientation || ("down" != f.orientation && d.top - s + i[1] + p > l && d.top > i[1])) &&
                      (d.top = d.top - i[1] - p),
                  (h.style.left = (d.left < 0 ? 0 : d.left) + 2 + "px"),
                  (h.style.top = d.top + p + "px"))
                : (a || (a = {}),
                  (h.style.position = a.position || "absolute"),
                  (h.style.left = a.left || o / 2 - i[0] / 2 + "px"),
                  (h.style.top = a.top || l / 2 - i[1] / 2 + "px")),
            a2a[_].doc_click_close_mini ||
                a2a[_].no_hide ||
                ((a2a[_].doc_click_close_mini =
                    ((m = _),
                    function (e) {
                        (!a2a.ieo() && "number" == typeof e.button && 0 < e.button) ||
                            (a2a[_].last_focus && a2a[_].last_focus.focus(), a2a.toggle_dropdown("none", m));
                    })),
                (a2a.show_menu["doc_click_listener_" + _] = a2a.add_event(
                    document,
                    y,
                    a2a[_].doc_click_close_mini,
                    k
            ...
            (a2a.show_menu.key_listener[_] = a2a.add_event(document, "keydown", function (e) {
                27 != ((e = e || window.event).which || e.keyCode) ||
                    a2a.overlay.key_listener ||
                    a2a.toggle_dropdown("none", _);
            })),
            a2a.svg.load();
            ...
            if ("mail" != e) {
                for (
                    var u = 0,
                        p = s.most,
                        m = p.length,
                        f = parseInt(a2a[e].num_services),
                        _ = 0,
                        g = a2a[e].exclude_services;
                    u < m;
                    u++
                ) {
                    var h = p[u];
                    (g && a2a.in_array(h[1], g, !0)) || l.appendChild(o(h[0], h[1], h[2], h[3], h[4])),
                        !(_ < f) ||
                            (g && a2a.in_array(h[1], g, !0)) ||
                            (r.appendChild(o(h[0], h[1], h[2], h[3], h[4])), _++);
                }
                i(n + "_full_services").appendChild(l), i(n + "_mini_services").appendChild(r);
            }
            (t = i(n + "_full_services")),
                (d.className = "a2a_i"),
                (a = d.cloneNode()),
                t.appendChild(d),
                t.appendChild(a);
    ...
    copyLink: function (e) {
        ...
        (a2a.show_full.full_shown = a2a.isDisplayed(t)),
            a2a.copyLink.clickListen ||
                (a2a.add_event(l, "click", function (e) {
    ...
    thanks: {
        ...
        show: function () {
            ...
            a2a.ads.lit() &&
                ...
                !a2a.thanks.showing &&
                "none" === n(i, "display") &&
                (a2a.isDisplayed(o) ? a2a.animate("hide", o, c) : c());
        },
        showing: !1,
    },
                ...
                a.removeEventListener(n, r),
                    ...
                    (function p(e) {
                        var a,
                            ...
                            c = "a2a_thanks_kit",
                            d = t(c);
                        d || (((d = m.createElement("div")).id = c), s.appendChild(d)),
                            (d.innerHTML = ""),
                        ...
                        (a.innerHTML = n), d.appendChild(a), a2a.init("page", { target: a }), (a2a.type = r);
                    })(e);
            }));
    },
    loadExtScript: function (e, t, n) {
        var a = document.createElement("script");
        if (((a.charset = "UTF-8"), (a.src = e), document.body.appendChild(a), "function" == typeof t))
    ...
    domEval: function (e, a) {
        ...
        (a.innerHTML = e),
            (function r(e) {
                var t,
                    a = e.querySelectorAll("script"),
                    n = [];
                [].forEach.call(a, function (a) {
                    ((t = a.getAttribute("type")) && !o.test(t)) ||
                        n.push(function (e) {
                            !(function n(e, a) {
    ...
    ads: {
        ...
        has: function (e) {
            var a = {},
                ...
                n = window;
            return (
                (("object" == typeof adsbygoogle && adsbygoogle.loaded) ||
                    "object" == typeof google_ad_modifications) &&
                    (a.as = t = !0),
                "object" == typeof googletag &&
                    googletag.slots &&
                    "function" == typeof Object.keys &&
                    0 < Object.keys(googletag.slots).length &&
                    (a.dc = t = !0),
        ...
        set: function (e) {
            ...
            function d() {
                var e = window.innerHeight,
                    a = e < 460,
                    t = Math.max(0.5, (e / 600).toFixed(1)),
                    ...
                    : e &&
                      (function p() {
                          ...
                          r && (r.style.display = "none"),
                              l
                                  ? window.postMessage &&
                                    i("a2a_thanks_ifr").contentWindow.postMessage("a2a_refresh_slot1", "*")
                                  : ((function n() {
                                    ...
                                    (e.style = t),
                                    (l.style =
                                        t + "display:none;border-radius:6px;margin:45px auto 0;overflow:hidden;"),
                                    s.appendChild(l),
                                    d(),
    ...
    util_frame_make: function (e) {
        ...
        (a.id = "a2a" + e + "_sm_ifr"),
            ...
            (a.src =
                "https://static.addtoany.com/menu/sm.22.html#type=" +
                e +
                "&event=load&url=" +
                o +
                "&referrer=" +
    ...
    urlParam: function (e, a, t) {
        var n,
            i,
            o = new RegExp("[?&]" + a.replace(/[.\\+*?\[\^\]$(){}=!<>|:\-]/g, "\\$&") + "=([^&#]*)", "i"),
            l = o.exec(e);
        null === l
            ? (i = e + (n = /\?/.test(e) ? "&" : "?") + a + "=" + t)
            : ((n = l[0].charAt(0)), (i = e.replace(o, n + a + "=" + t)));
        return i;
    },
    fix_icons: function () {
        var e = a2a.ieo();
        if (e && e < 9) {
            ...
            if (a && !a.a2aFixed && !a.currentStyle.backgroundImage.split('"')[1] && t < 999)
                return (a2a.fix_icons.tryNum = t + 1), setTimeout(a2a.fix_icons, 99);
    ...
    top_services: function (e, a, t) {
        ...
        if (e) {
            ...
            if (0 < u.length) {
                var f, _, g;
                for (p = 0, t = t; p < u.length; p++)
                    (g = (f = i(u[p].a2a.safename, d, !0, "a2a", "safename"))
                        ? f
                        : o((_ = u[p].a2a).servicename, _.safename, _.serviceIcon, _.serviceColor, {
                              src: _.js_src,
                              url: _.url,
                              type: _.serviceType,
                              pu: _.popup,
    ...
    css: function () {
        ...
        (e =
            ...
            ("undefined" != typeof document.body.style.maxHeight
                ? m + "clear{clear:both}"
                : m + "clear{clear:both;height:0;width:0;line-height:0;font-size:0}") +
            " " +
            m +
            ...
            i.styleSheet ? (i.styleSheet.cssText = e) : ((a = document.createTextNode(e)), i.appendChild(a));
    },
    svg_css: function () {
        a2a.init("page");
        ...
        get: function (e, a, t) {
            ...
            return (
                ...
                svg_src
                    ...
                    : svg_src_default
                    ? ((svg_src_default = t ? i(svg_src_default, t) : svg_src_default),
                      svg_tag_open + svg_src_default + svg_tag_close)
                    : (a2a.svg.queue.push({ name: e, node: a, color: t }), "pending")
            );
        },
        set: function (e) {
            var a = a2a.svg,
        ...
        works: function () {
            var e = document,
                a = !(
                    ...
                    !e.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1") ||
    ...
    make_service: function (m, f, e, a, t, n, i) {
        ...
        return (
            ...
            (_.a2a.safename = f),
            (_.a2a.servicename = m),
            (_.a2a.serviceNameLowerCase = m.toLowerCase()),
            (_.a2a.serviceIcon = e),
            (_.a2a.serviceColor = a),
            (_.a2a.serviceType = t.type),
            (_.innerHTML = "<span></span>" + m + " "),
            (o = _.firstChild),
            t.type && (_.a2a.stype = t.type),
            t.src && (_.a2a.js_src = t.src),
            t.url && (_.a2a.url = t.url),
            t.pu && (_.a2a.popup = 1),
            t.media && (_.a2a.media = 1),
            n && (_.a2a.customserviceuri = n),
            i
                ? ((o.style.backgroundImage = "url(" + i + ")"), (o.className = c))
                : d && a2a.svg.works()
                ? ((o.className = c + " a2a_s_" + e),
                  p && "unset" != p ? (o.style.backgroundColor = p) : a && (o.style.backgroundColor = "#" + a),
                  h && (h = h.trim()))
                : e
                ? ((o.className = c + " a2a_s_" + e), a && (o.style.backgroundColor = "#" + a))
                : (o.className = c),
            i || ("pending" !== (l = a2a.svg.get(e, o, h)) && (o.innerHTML = l)),
            "js" === _.a2a.stype
                ? a2a.add_event(_, "click", s)
                : (a2a.add_event(_, "mousedown", s), a2a.add_event(_, "keydown", s)),
            "copy_link" == f &&
                a2a.add_event(_, "mouseenter", function () {
                    (a2a.gEl("a2a_modal").style.willChange = "transform, opacity"),
                        (a2a.gEl("a2a_overlay").style.willChange = "backdrop-filter, opacity");
                }),
            a2a.add_event(_, "click", function (e) {
                var a,
                    t = a2a["n" + a2a.n],
                    n = { node: _, service: m, title: t.linkname, url: t.linkurl, media: t.linkmedia },
                    i = encodeURIComponent,
                ...
                void 0 !== u &&
                    ...
                    a2a.linker(_),
                    u.stop && ((p = !0), a2a.preventDefault(e))),
                    ...
                    !r.popup ||
                        ...
                        window.open(
                            ...
                            "_blank",
                            "toolbar=0,personalbar=0,resizable,scrollbars,status,width=550,height=450,top=" +
                                (450 < c ? Math.round(c / 2 - 225) : 40) +
                                ",left=" +
                                Math.round(screen.width / 2 - 275)
                        )),
                    (a = r.js_skip),
                    (!r.externalJS && !r.literalJS) || p || a || a2a.runJS(r),
                    s && !a && a2a.preventDefault(e),
                    a && delete _.a2a.js_skip,
                    a2a.util_frame_post(g, d),
                    a2a.GA.track(m, f, t.linkurl, o, l);
            }),
            _
        );
    },
    ...
    localize: function () {
        ...
        for (var o, l, r, s, c, d = 0, u = e.length; d < u; d++)
            (l = (l = (o = e[d]).getAttribute("data-a2a-localize")) ? l.split(",", 2) : l) &&
                ((s = l[0]),
                (c = a[(r = l[1])] || t[r] || ""),
                "inner" === s
                    ? (o.innerHTML = c)
                    : "label" === s
                    ? o.setAttribute("aria-label", n(c))
                    : "title" === s && o.setAttribute("title", n(c)));
    },
    locale: {
        Share: "Share",
        Save: "Save",
                ...
                (a2a["create_" + a2a.type + "_html"] = function (e, a) {
                    ...
                    if (
                        ...
                        o ||
                            ...
                            (r +=
                                '<div id="a2a_modal" class="a2a_modal" role="dialog" tabindex="-1" aria-label="" style="display:none">'),
                            (r +=
                                '<div class="a2a_modal_body a2a_menu" id="a2a_copy_link" style="display:none"><span id="a2a_copy_link_icon" class="a2a_svg a2a_s_link"' +
                                k +
                                '><svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path fill="' +
                                y +
                            ...
                            (r +=
                                '<div class="a2a_modal_body a2a_menu a2a_thanks" id="a2a_thanks" style="display:none"><div class="a2a_localize" data-a2a-localize="inner,ThanksForSharing">' +
                                x.ThanksForSharing +
                                "</div></div>"),
                            (r += "</div>")),
                        (l +=
                            ...
                            c +
                            '_dropdown" class="a2a_menu a2a_mini a2a_localize" tabindex="-1" aria-label="' +
                            ("feed" == c ? x.Subscribe : x.Share) +
                            '" data-a2a-localize="label,' +
                            ("feed" == c ? "Subscribe" : "Share") +
                            '" style="display:none"><div id="a2a' +
                            c +
                            '_title_container" class="a2a_menu_title_container" style="display:none"><div id="a2a' +
                            c +
                        ...
                        a2a.add_event(o, "click", a2a.stopPropagation),
                            a2a.add_event(o, "touchstart", a2a.stopPropagation, !!a2a.evOpts() && { passive: !0 }),
                            (o.innerHTML = r + l);
                    }
                    o.id != A &&
                        ...
                        (n = s(d + "_dropdown")) &&
                            m &&
                            (a2a.add_event(n, "mouseenter", a2a.miniEnterStay),
                            a2a[c].onclick || a2a.add_event(n, "mouseleave", a2a.miniLeaveDelay)),
                        (t = s(d + "_find")) &&
                            (a2a.add_event(s(d + "_find_icon"), "click", a2a.focus_find),
                            a2a.add_event(t, "click", a2a.focus_find),
                            a2a.add_event(t, "keyup", a2a.do_find)),
                        (i = s("a2a_copy_link_icon")) &&
                            a2a.add_event(i, "click", function () {
                                s("a2a_copy_link_text").click();
                            }),
                        (a2a[c].services = a),
                        a2a.add_event(s("a2a_overlay"), "click", function (e) {
                            a2a.hide_modals(c);
                        }),
                        "mail" != c &&
                            a2a.add_event(s(d + "_show_more_less"), "click", function (e) {
                ...
                page: {
                    most: [
                        ...
                        [
                            ...
                            "pinterest",
                            "BD081C",
                            { type: "js", src: "https://assets.pinterest.com/js/pinmarklet.js", media: 1, pu: 1 },
                        ],
                        ...
                        [
                            ...
                            "houzz",
                            "7AC143",
                            { type: "js", src: "https://www.houzz.com/js/clipperBookmarklet.js", media: 1, pu: 1 },
                        ],
                        ...
                        [
                            ...
                            "yummly",
                            "E16120",
                            { type: "js", src: "https://www.yummly.com/js/yumlet.js", media: 1, pu: 1 },
                        ],
                    ],
                    email: [

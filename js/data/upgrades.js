SharkGame.Upgrades = {
	...
	getUpgradeTable: function() {
		var worldType = SharkGame.World.worldType;
		if(worldType === "stone") {
	...
	standardUpgrades: {
		...
		iterativeDesign: {
			...
			desc: "The machines are good, but they could totally be better. Let's build them over and over until they're better!",
			researchedMessage: "After hundreds of hours of testing, the final product has our machines running way fast! Dangerously fast, maybe!",
		...
		knowledgeCoalescers: {
			...
			desc: "The dolphins say they have a design to accrue knowledge directly from the ocean. Maybe we should hear them out.",
			researchedMessage: "With enough staring, we managed to decipher the cryptic and unhelpful instructions they gave us. Turns out, it's not a machine...it's more like an altar.",
	...
	stoneUpgrades: {
		...
		seabedGeology: {
			...
			desc: "Study the bottom of the ocean to determine the rich, deep, juicy secrets it contains.",
			researchedMessage: "The rays found that there was a bunch of rocky sediment on the seafloor. This requires further study!",
			effectDesc: "Rays find twice as many fish by understanding their hiding spots. Also, gravel has been discovered. This is...useful??",
			cost: {
				science: 250
			},
			required: {
		...
		spongeCollection: {
			name: "Sponge Collection",
			desc: "We can see these things littering the rocks and boulders, but we don't know how to collect them without breaking them.",
			researchedMessage: "Understanding the fragile nature of sponges and their weird porous texture, we can now collect sponges by not biting so hard.",
		...
		clamScooping: {
			name: "Clam Scooping",
			desc: "We see these things all over the seabed but we can't tell which are clams and which are rocks.",
			researchedMessage: "Patient observation has shown that clams and rocks are in fact different and distinct things. Now we won't be scooping up any more rocks (at least, not on accident)!",
			effectDesc: "Clams can be collected like fish.",
			cost: {
				science: 750
			},
		...
		prospectorSharks: {
			...
			researchedMessage: "The heat from thermal vents lets us sharpen existing crystals enough to break new ones off the walls!",
		...
		gravelPulverizing: {
			...
			researchedMessage: "A tight set of tumblers destroys anything inserted into its gaping maw. It's a wonder of science! And extremely lethal! Heed the caution signs!",
		...
		rockProcessing: {
			...
			desc: "Despite all of our advancements, we still can't seem to break stone quickly! Maybe a machine can help?",
		...
		rayBiology: {
			...
			desc: "Though kindred to the sharks, we know so little about the rays. If only we could fix this. We need to bait a sand trap.",
			researchedMessage: "Apparently we could have just asked. We learned how rays make more rays. It's kinda similar to sharks, really, but rays.",
			effectDesc: "Rays and shoveler rays are twice as effective. We may never repair the shark-ray relations to their former state after how awkward this whole affair was.",
			cost: {
				science: 700,
				gravel: 250
			},
		...
		gravelMilling: {
			name: "Gravel Milling",
			desc: "We've hit a dead end, but the crabs just had an idea. Maybe with all this gravel we've been collecting, we could find a way to make sand?",
			researchedMessage: "As it turns out, we were totally onto something. Specialized equipment lets crabs grind up gravel into sand!",
		...
		crabBiology: {
			name: "Crab Biology",
			desc: "Crabs are a mystery. They keep to themselves and dig up crystals or break down pebbles. What is even up with that? What ARE crabs??",
			researchedMessage: "It turns out crabs are friendly crustaceans that have revealed to the sharks the secrets of crab generation. It involves eggs, or something. Squirmy eggs.",
			effectDesc: "Crabs and miller crabs are twice as effective. Crabs are alright but they are also sort of terrifying and weird. Good job they're on our side!",
			cost: {
				science: 500,
				fish: 450
			},
		...
		rockBreaking: {
			...
			researchedMessage: "Okay, so given some specialized training, it's not too big for lobsters to break. Noted.",
		...
		sharkoniumBreakingGear: {
			...
			researchedMessage: "Sharkonium rock-crackers have been developed and are being deployed to all rock lobsters.",
		...
		sharkoniumPickaxes: {
			...
			researchedMessage: "As it turns out, sharkonium is perfect for the job! Crystals are literally flying off the walls! It's dangerous, but productive!",
		...
		miningLights: {
			name: "Mining Lights",
			desc: "Now that I think about it, I guess it IS really dark in the caves...maybe we could invent some sort of...miniature suns to help?",
		...
		iterativeDesign: {
			name: "Iterative Design",
			desc: "The machines are good, but they could totally be better! Let's keep building them until they're better!",
			researchedMessage: "After hundreds of hours of testing, the final product has our machines running faster than ever!",
		...
		exploration: {
			name: "Exploration",
			desc: "Swim beyond the home seas to see what can be found!",
			researchedMessage: "Found lots of schools of fish! So many different schools! And such untapped gravel reserves!",
		...
		farExploration: {
			...
			desc: "Explore the vast reaches beyond the home ocean.",
			researchedMessage: "Crystal-rich deposits were found, as well as strange, deep chasms.",
			effectDesc: "Crabs are four times as effective, and prospectors are doubly effective. Did you know oceans are actually even bigger than big? Remarkable!",
			cost: {
				science: 8000,
				fish: 15000
			},
